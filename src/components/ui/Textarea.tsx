    ...
    return (
      <div className="w-full flex flex-col mb-5 last:mb-0">
        ...
        <textarea
          ...
          className={cn(
            "w-full transition-all duration-200 text-sm placeholder:text-on-surface-variant/60 text-on-surface leading-relaxed rounded-xl px-4 py-3 border border-outline bg-surface resize-none",
