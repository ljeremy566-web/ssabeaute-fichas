...
export function PatientDirectoryToolbar({
  ...
  return (
    <div className="space-y-4 mb-4">
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <div className="flex gap-2 shrink-0">
          ...
          >
            ...
            Filtros
            {consentFilter !== 'all' && (
              <span className="text-xs font-medium opacity-80">({activeFilterLabel})</span>
            )}
          </button>
          <Select
            value={sortBy}
      ...
      {filtersOpen && (
        <div className="p-4 rounded-xl border border-border bg-surface-container/40 animate-fade-in">
          <p className="text-xs font-semibold uppercase tracking-wide text-muted mb-3 font-outfit">
            Consentimiento
          </p>
